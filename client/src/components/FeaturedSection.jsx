...
const Featuredsection = () => {
    ...
    return (
        <div className='px-6 md:px16 lg:px-16 xl:px-44 overflow-hidden'>
            ...
            <div className='flex justify-center mt-20'>
                <button onClick={()=>{navigate('/movie'); scrollTo(0,0)}} className='px-10 py-3 text-sm bg-primary hover:bg-primary-dull transition rounded-md font-medium cursor-pointer'> 
                    Show More</button>
            </div>
        </div>
    )
